...
class ProfileController extends Controller
{
    ...
    public function updateProfileAction($id,Request $request)
    {
        ...
        $profile=$this->getDoctrine()->getRepository('AppBundle:Profile')->findOneBy(array('userId'=>$id));
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $profile=$em->getRepository('AppBundle:Profile')->findOneBy(array('userId'=>$id));
    ...
    /**
     * @Route("{_locale}/profile_settings/{id}", name="profile_settings")
     */
